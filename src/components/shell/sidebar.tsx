...
function buildNav(unread: number): NavItem[] {
  return [
    ...
    { type: "link", key: "licitaciones", href: "/licitaciones", label: "Licitaciones", icon: "gavel", badge: 8 },
    { type: "link", key: "ordenes", href: "/ordenes", label: "Órdenes", icon: "clipboard-list", badge: 12 },
    { type: "link", key: "agenda", href: "/agenda", label: "Agenda y visitas", icon: "calendar-days" },
    { type: "link", key: "reportes", href: "/reportes", label: "Reportes y documentos", icon: "file-text" },
    { type: "section", label: "Red Piramid" },
    { type: "link", key: "marketplace", href: "/marketplace", label: "Marketplace", icon: "store" },
    { type: "link", key: "perfil-publico", href: "/marketplace/mi-ficha", label: "Mi ficha pública", icon: "globe" },
    { type: "section", label: "Proveedor" },
    { type: "link", key: "perfil", href: "/perfil", label: "Perfil operativo", icon: "building-2" },
    { type: "link", key: "scorecard", href: "/scorecard", label: "Performance", icon: "trending-up" },
    { type: "link", key: "notificaciones", href: "/notificaciones", label: "Notificaciones", icon: "bell", badge: unread },
